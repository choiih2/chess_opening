...
**힌트는 통계와 엔진을 함께 봅니다.** 연습 중 "힌트 보기"를 누르면 그 국면의
Lichess 실전 메인라인과, Stockfish가 다른 후보보다 확실히 낫다고 보는 수(1.5폰 이상
차이)를 함께 보여줍니다. 메인라인이 곧 엔진 최선일 때는 그렇다고 표시하고, 아니면
"탁월한 수"로 따로 화살표를 그립니다. 오답을 두면 나오는 화살표는 내 레퍼토리에
등록된 수를 알려주는 것으로, 힌트와는 별개입니다.
